...
EXERCISE_TECH_MAP = [
    ...
    ("сгибания гантелей стоя", "biceps_dumbbell"),    # ← уникальная
...
def nutrition_examples_kb():
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text="✍️ Записать калории за сегодня", callback_data="nutr:log_kcal")],
...
FAQ_QUESTIONS = {
    "faq:weight": {
        ...
        "a": (
            "⚖️ Вес стоит — что делать?\n\n"
            "Ты ешь столько же, сколько тратишь. Всё просто.\n\n"
            "Проверь три вещи:\n\n"
            "1. Ты считаешь всё?\n"
            "Соусы, масло, перекусы — часто 300–500 ккал «в никуда».\n"
            "Пример: 1 ст. л. масла = 120 ккал. 2 горсти орехов = 300 ккал.\n"
            "Неделю взвешивай всё, что ешь — результат удивит.\n\n"
            "2. Ты взвешиваешься правильно?\n"
            "Норма: утром, натощак, после туалета.\n"
            "Смотри среднее за неделю, а не на один день.\n\n"
            "3. Что делать прямо сейчас?\n"
            "Вес стоит 2 недели → убери 150–200 ккал в день.\n"
            "Жди ещё неделю. Если не пошло — убирай ещё 100."
        )
    },
    "faq:muscle": {
        ...
        "a": (
            ...
            "Не хватает хотя бы одного — роста нет.\n\n"
            "Чаще всего проблема в одном из этих:\n\n"
            "1. Нет прогрессии в нагрузке\n"
            "Делаешь одни и те же веса несколько месяцев?\n"
            "Тело адаптировалось. Нужен стимул.\n"
            "Что делать: раз в 1–2 недели добавляй 2.5 кг или 1 повтор.\n\n"
            "2. Мало белка\n"
            "Нужно 1.8–2.2 г на кг веса.\n"
            "При 75 кг → 135–165 г белка в день.\n"
            "Источники: курица, рыба, яйца, творог.\n\n"
            "3. Мало калорий\n"
            "На дефиците мышцы не растут.\n"
            "Для роста нужен профицит +200–400 ккал в день.\n\n"
            "4. Мало сна\n"
            "Меньше 7 часов = мышцы не восстанавливаются.\n"
            "Попробуй 2 недели спать 8 часов — разница заметна."
        )
    },
    "faq:plateau": {
        ...
        "a": (
            "📉 Плато — как выйти\n\n"
            "Тело привыкло к нагрузке. Это нормально.\n"
            "Плато через 6–10 недель стабильных тренировок — ожидаемо.\n\n"
            "Три простых шага:\n\n"
            "1. Смени программу\n"
            "Нажми «Составить новый план» в профиле.\n"
            "Другие упражнения — новый стимул для мышц.\n\n"
            "2. Сделай разгрузочную неделю\n"
            "Снизь веса на 30%, работай на технику.\n"
            "Через неделю обычно идёт рост.\n\n"
            "3. Проверь питание\n"
            "Незаметно выросли калории?\n"
            "Неделю записывай всё — часто находишь лишние 300–500 ккал.\n\n"
            "Пример:\n"
            "Присед 80 кг стоит 4 недели?\n"
            "Возьми 75 кг + пауза 2 сек внизу.\n"
            "Через 2 недели 82.5 пойдут легче."
        )
    },
    "faq:diet": {
        ...
        "a": (
            ...
            "Два правила, которые дают 90% результата:\n"
            "1. Попадай в калории.\n"
            "2. Ешь достаточно белка.\n\n"
            "Как считать калории:\n"
            "Иди в раздел «Питание» — там уже есть твои цифры.\n"
            "Приложение FatSecret удобно для записи еды.\n\n"
            "Сколько белка?\n"
            "1.8–2 г на кг веса. При 70 кг → 126–140 г в день.\n"
            "За один приём пищи: курица 150 г + яйцо = ~45 г белка.\n\n"
            "Углеводы и жиры:\n"
            "Не убирай жиры — нужно минимум 0.7 г на кг.\n"
            "Углеводы за 1–2 часа до тренировки = больше энергии.\n\n"
            "Первый шаг прямо сейчас:\n"
            "Добавь белок к каждому приёму пищи.\n"
            "Это одно изменение уже даст результат за 3–4 недели."
        )
    },
    "faq:motivation": {
        ...
        "a": (
            ...
            "Главное — не прерывать полностью.\n\n"
            "2. Записывай результаты\n"
            "Дневник тренировок: рост в цифрах видно через 3–4 недели.\n"
            "Фото раз в 4 недели: весы врут, зеркало и фото — нет.\n\n"
            "3. Пропустил тренировку?\n"
            "Ничего страшного. Просто иди на следующую.\n"
            "Одна пропущенная тренировка не ломает результат.\n\n"
            "Реальные сроки:\n"
    ...
    "faq:sleep": {
        ...
        "a": (
            "😴 Сон — самое недооценённое средство роста\n\n"
            "Мышцы растут не во время тренировки, а после — во сне.\n"
            "Тренировка даёт стимул. Сон — когда происходит рост.\n\n"
            "Факты простым языком:\n"
            "— 6 часов сна: рост мышц и жиросжигание замедляются\n"
            "— 7–9 часов: оптимум\n"
            "— Хронический недосып: кортизол растёт → жир накапливается\n\n"
            "Как понять, что не восстанавливаешься:\n"
            ...
            "3. Прохладная комната (18–20°C) улучшает качество сна\n\n"
            "Попробуй 2 недели спать 8 часов — почти всегда\n"
            "веса начинают расти снова."
        )
    },
    "faq:technique": {
        ...
        "a": (
            ...
            "Пример:\n"
            "Присед с круглой спиной → нагрузка на поясницу, не на ноги.\n"
            "Тяга блока «руками» → работает бицепс, не спина.\n\n"
            "Как освоить технику быстро:\n"
            "1. Первые 2–4 недели — работай с 50–60% от максимума\n"
            "2. Нажимай «Техника» под каждым упражнением в боте\n"
            "3. Снимай себя на видео — ошибки сразу видны\n\n"
            "Когда техника освоена:\n"
            "Добавляй 2.5 кг каждые 1–2 недели.\n"
            "Не можешь добавить — значит ещё не время.\n\n"
    ...
    "faq:cardio": {
        ...
        "a": (
            ...
            "Коротко: не обязательно, но полезно.\n"
            "Зависит от цели.\n\n"
            "Для похудения:\n"
            "Помогает создать дефицит без урезания еды.\n"
            "Формат: 2–3 раза в неделю по 25–35 мин в отдельные дни.\n"
            "Что подходит: ходьба быстрым шагом, велосипед, эллипс.\n\n"
            "Для набора массы:\n"
            "Много кардио = тело использует мышцы как топливо.\n"
            "Максимум: 1–2 раза по 20 мин, для здоровья сердца.\n\n"
            "Что делать новичку:\n"
            "Первые 2–3 месяца — только силовые.\n"
            "Научись технике, привыкни к нагрузке.\n"
...
async def show_main_menu(bot: Bot, chat_id: int, user_id: int):
    ...
    text = (
        ...
        f"Питание: {nutrition_done}/7  {n_done_str}{n_check}\n\n"
        f"{tariff_line}\n\n"
...
async def open_nutrition(user_id: int, chat_id: int, bot: Bot, callback: Optional[CallbackQuery] = None):
    ...
    # Блок: сегодня из nutrition_logs (пользователь вводил сам)
    actual_kcal_logged = await get_nutrition_log_today(user_id)
    if actual_kcal_logged is not None:
        dev = actual_kcal_logged - calories
        dev_str = f"{'+' if dev >= 0 else ''}{dev}"
        status_str = "Закрыто ✅" if abs(dev) <= 100 else "Не закрыто ❌"
        today_block = (
            "\nСегодня:\n"
            f"Цель: {calories} ккал\n"
            f"Факт: {actual_kcal_logged} ккал\n"
            f"Отклонение: {dev_str} ккал\n"
            f"Статус: {status_str}\n"
        )
    else:
        today_block = "\nСегодня данных ещё нет.\nНажми «Записать калории за сегодня» — введи фактически съеденное.\n"
...
async def cb_nutr_log_kcal(callback: CallbackQuery, state: FSMContext, bot: Bot):
    """Запуск ввода калорий за сегодня."""
    if not await is_full_access_active(callback.from_user.id):
    ...
    await state.set_state(NutritionLog.enter_calories)
    text = "Сколько калорий ты съел сегодня?\n\nВведи числом, например: 2340"
    await clean_edit(callback, callback.from_user.id, text, reply_markup=InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="⬅️ Отмена", callback_data="nutr:back")],
    ]))
    await callback.answer()


async def nutr_log_kcal_text(message: Message, state: FSMContext, bot: Bot):
    """Пользователь вводит количество калорий."""
    raw = (message.text or "").strip().replace(",", ".")
    try:
        kcal = int(float(raw))
    except ValueError:
        await message.answer("Введи число, например: 2340")
        await try_delete_user_message(bot, message)
        return

    if kcal < 100 or kcal > 15000:
        await message.answer("Похоже на ошибку. Введи реальное число калорий за день.")
        await try_delete_user_message(bot, message)
        return

    uid = message.from_user.id
    u = await get_user(uid)
    _, calories, _, _, _, _ = generate_nutrition_summary(
        u["goal"], u["sex"], int(u["age"]), int(u["height"]), float(u["weight"]), u["exp"],
        freq=int(u["freq"]), place=u["place"], meals_pref=int(u.get("meals") or 0)
    )

    await save_nutrition_log(uid, kcal)

    # Если в пределах цели — считаем день закрытым
    if abs(kcal - calories) <= 100:
        await mark_nutrition_day(uid)
    ...
    await state.clear()
    await try_delete_user_message(bot, message)
    await clean_send(bot, message.chat.id, uid, text, reply_markup=InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="⬅️ Назад к питанию", callback_data="nutr:back")],
        [InlineKeyboardButton(text="🏠 Меню", callback_data="nav:menu")],
    ]))
...
def setup_handlers(dp: Dispatcher):
    ...
    dp.callback_query.register(cb_nutr_log_kcal, F.data == "nutr:log_kcal")
    dp.message.register(nutr_log_kcal_text, NutritionLog.enter_calories)
