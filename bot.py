...
FAQ_QUESTIONS = {
    "faq:weight": {
        ...
        "a": (
            ...
            "Одна причина для всех целей: калории не совпадают с твоим расходом.\n\n"
            "─── Почему вес может стоять ───\n\n"
            "1. Скрытые калории\n"
            "Соусы, масло, орехи, перекусы — всё считается.\n"
            "1 ст.л. масла = 90 ккал. 2 горсти орехов = 300 ккал.\n"
            "За день «незаметных» калорий набегает 300–600.\n\n"
            "2. Неправильное взвешивание\n"
            "Правило: утром, после туалета, натощак, без одежды.\n"
            "Смотри среднее за 7 дней — не на отдельный день.\n"
            "Колебания ±1–2 кг за день — это вода, не жир.\n\n"
            "3. Слишком мало времени\n"
            "Тело меняется медленнее, чем кажется.\n"
            "Жди минимум 2 недели, прежде чем менять калории.\n\n"
            "─── Что делать — зависит от цели ───\n\n"
            "🎯 Хочешь похудеть, но вес стоит:\n"
            "→ Убери 150–200 ккал в день (убери перекус или уменьши порцию)\n"
            "→ Или добавь 20–30 мин ходьбы 3 раза в неделю\n"
            "→ Жди 2 недели — если нет результата, убирай ещё 100 ккал\n\n"
            "🎯 Хочешь набрать массу, но вес стоит:\n"
            "→ Добавь 150–200 ккал в день (кефир, орехи, доп. порция каши)\n"
            "→ Жди 2 недели — если вес не растёт, добавляй ещё 100 ккал\n"
            "→ Цель: +0.5–1 кг в неделю — оптимальный темп набора\n\n"
            "🎯 Вес растёт, но ты на сушке:\n"
            "→ Убери 100–150 ккал и неделю понаблюдай\n"
            "→ Проверь скрытые калории в еде\n\n"
            "─── Главное правило ───\n\n"
            "Меняй калории маленькими шагами по 100–150 ккал за раз.\n"
            "После каждого изменения жди 2 недели.\n"
            "Вес на весах — это тренд за неделю, не один день."
        )
    },
    "faq:muscle": {
        ...
        "a": (
            ...
            "нагрузка + достаточно еды + сон.\n\n"
            "─── Самые частые причины ───\n\n"
            "1. Нет прогрессии\n"
            "Одни и те же веса месяцами — тело адаптировалось.\n"
            "Решение: раз в 1–2 недели добавляй +2.5 кг или +1 повтор.\n\n"
            "2. Мало белка\n"
            "На массу нужно 1.8–2 г/кг.\n"
            "При 75 кг → 135–150 г белка в день.\n"
            "Просто: творог 200г + куриное бедро 200г + 3 яйца = ~107г Б.\n\n"
            "3. Мало калорий\n"
            ...
            "─── Главное для новичка ───\n\n"
            "Первые 3–6 месяцев мышцы растут быстро.\n"
            "Ключ — регулярность тренировок и прогрессия весов."
        )
    },
    "faq:plateau": {
        ...
        "a": (
            ...
            "Тело привыкло к нагрузке. Это нормально через 6–10 недель.\n\n"
            "─── Три шага выхода ───\n\n"
            "1. Смени программу\n"
            "Нажми «Сменить план тренировок» — новые упражнения дадут новый стимул.\n\n"
            "2. Разгрузочная неделя\n"
            "Снизь рабочие веса на 30% и работай только на технику.\n"
            "После такой недели обычно идёт прорыв.\n\n"
            "3. Проверь питание\n"
            ...
            "Больше месяца — пора менять подход кардинально."
        )
    },
    "faq:progression": {
        ...
        "a": (
            ...
            "→ За 2 месяца рабочий вес вырос на 10 кг.\n\n"
            "─── Как добавлять нагрузку ───\n\n"
            "Шаг 1 — добавь повторение\n"
            "Работаешь 3×6 — дойди до 3×8, потом повышай вес.\n\n"
            "Шаг 2 — добавь вес\n"
            "Сделал все подходы чисто → +2.5 кг в следующий раз.\n\n"
            "Шаг 3 — добавь подход\n"
            "Не готов к большему весу — добавь 4-й подход.\n\n"
            "─── Когда добавлять вес ───\n\n"
    ...
    "faq:diet": {
        ...
        "a": (
            ...
            "1. Попадай в свою норму калорий.\n"
            ...
            "─── Белок ───\n\n"
            "Нужно 1.8–2 г/кг веса тела.\n"
            "При 70 кг → 126–140 г белка в день.\n\n"
            "Легко набрать:\n"
            "• Яйца 3 шт. = 18 г Б\n"
            "• Куриное бедро 200 г = 54 г Б\n"
            "• Творог 200 г = 35 г Б\n"
            "Итого: ~107 г без особых усилий.\n\n"
            "─── Чего не надо делать ───\n\n"
            "• Убирать жиры — нужно минимум 0.7 г/кг\n"
            "• Убирать углеводы — они дают энергию для тренировок\n"
            "• Есть «чисто» 100% времени — важна стабильность, не идеальность\n\n"
            "Первый шаг: добавь белковый продукт к каждому приёму пищи.\n"
            "Это одно изменение даёт результат за 3–4 недели."
        )
    },
    "faq:motivation": {
...
async def cb_nav(callback: CallbackQuery, state: FSMContext, bot: Bot):
    ...
    if key == "menu":
        ...
        text = (
            "📈 Как прогрессировать\n\n"
            "Прогрессия — это когда каждую неделю ты делаешь чуть больше, чем раньше.\n"
            "Без этого мышцы и сила перестают расти.\n\n"
            "─── Простой пример ───\n\n"
            "Неделя 1: жим лёжа 60 кг × 8 повторений\n"
            "Неделя 2: жим лёжа 60 кг × 9 повторений\n"
            "Неделя 3: жим лёжа 62.5 кг × 8 повторений\n\n"
            "Вот и всё. Ты стал сильнее.\n\n"
            "─── 4 способа сделать тренировку тяжелее ───\n\n"
            "1️⃣ Добавь вес\n"
            "Сделал 3 подхода по 8 чисто? Добавь 2.5 кг в следующий раз.\n\n"
            "2️⃣ Добавь повторения\n"
            "Пока не готов добавить вес — сделай на 1 повторение больше.\n\n"
            "3️⃣ Добавь подход\n"
            "Делал 3 подхода — попробуй 4. Больше объём = больше рост.\n\n"
            "4️⃣ Улучши технику\n"
            "Чище движение → мышца работает лучше → прогресс идёт быстрее.\n\n"
            "─── Когда добавлять вес ───\n\n"
            "✅ Сделал все подходы в нужном диапазоне (например 3 × 8)\n"
            "✅ Техника не ломается\n"
            "✅ Последние повторения тяжёлые, но выполнимые\n\n"
            "❌ Не добавляй вес если:\n"
            "— не добрал повторения в прошлый раз\n"
            "— техника нарушается\n"
            "— плохо спал или болишь\n\n"
            "─── Главное ───\n\n"
            "+2.5 кг каждые 2 недели = +65 кг к рабочему весу за год.\n"
            "Маленькие шаги каждую неделю — вот что даёт большой результат.\n\n"
            "Записывай веса в «Дневник тренировок» — так ты видишь рост."
        )
