...
FAQ_QUESTIONS = {
    "faq:weight": {
        ...
        "a": (
            "⚖️ Вес стоит — в чём причина?\n\n"
            "В 95% случаев: ты ешь ровно столько, сколько тратишь.\n"
            "Часто незаметно — из-за соусов, перекусов, «маленьких» добавок.\n\n"
            "Проверь:\n\n"
            "1. Считаешь ли ты калории со всем?\n"
            "Масло, соусы, перекусы — один незамеченный приём это 300–500 ккал.\n\n"
            "2. Взвешиваешься ли утром, натощак?\n"
            "Вес колеблется на 1–3 кг в течение дня — одна цифра ничего не говорит.\n\n"
            "3. Достаточно ли белка?\n"
            "Без белка тело теряет мышцы, а не жир. Норма: 1.8–2.2 г/кг.\n\n"
            "4. Пьёшь ли воду?\n"
            "2–3 литра в день. Задержка воды маскирует уход жира неделями.\n\n"
            "Что делать:\n"
            "— Взвешивай всю еду 2 недели подряд\n"
            "— Если нет -0.5 кг за неделю — снизь на 200 ккал\n"
            "— Жир уходит медленно, но при дефиците — уходит всегда"
        )
    },
    "faq:muscle": {
        ...
        "a": (
            ...
            "Для роста нужно три условия: нагрузка + питание + сон.\n"
            "Убери любое — прогресса не будет.\n\n"
            "Частые причины:\n\n"
            "1. Нет прогрессии\n"
            "Одна и та же нагрузка месяцами — тело адаптировалось.\n"
            "Решение: каждые 1–2 недели добавляй вес или повторения.\n\n"
            "2. Мало белка\n"
            "Менее 1.6 г/кг — мышцам не из чего строиться.\n"
            "На массу нужно 1.8–2.2 г/кг.\n\n"
            "3. Мало калорий\n"
            "На дефиците мышцы не растут. Для массы: +200–400 ккал к норме.\n\n"
            "4. Плохой сон\n"
            "Гормон роста выделяется ночью. Меньше 7 часов = медленный прогресс.\n\n"
            "5. Слишком много кардио\n"
            "Кардио каждый день + дефицит = тело использует мышцы как топливо.\n\n"
            "Правило: 3 недели без роста рабочего веса — меняй программу или питание."
        )
    },
    "faq:plateau": {
        ...
        "a": (
            "📉 Плато — как выйти?\n\n"
            "Тело адаптируется к нагрузке за 6–8 недель. Это нормально.\n"
            "Плато — не тупик, а сигнал поменять стимул.\n\n"
            "Частые причины:\n"
            "— Одна программа больше 2–3 месяцев\n"
            "— Нет прогрессии весов или повторений\n"
            "— Незаметно изменилось питание\n"
            "— Накопилась усталость\n\n"
            "Как выйти:\n\n"
            "1. Смени программу — кнопка «Обновить программу» в профиле\n"
            "2. Разгрузочная неделя: -30–40% нагрузки, только техника\n"
            "3. Добавь 100–200 ккал, если вес стоит давно\n"
            "4. Улучши сон: 7–9 часов — не рекомендация, а условие роста\n\n"
            "2–3 недели плато — норма. Больше месяца — нужно менять подход."
        )
    },
    "faq:diet": {
        ...
        "a": (
            ...
            "Не нужна идеальная диета. Нужен стабильный баланс.\n\n"
            "Основы:\n\n"
            "1. Калории — главное\n"
            "Похудение: дефицит 300–500 ккал.\n"
            "Масса: профицит 200–400 ккал. Всё остальное — детали.\n\n"
            "2. Белок — приоритет\n"
            "Минимум 1.6 г/кг, лучше 2 г/кг.\n"
            "Источники: курица, рыба, яйца, творог.\n\n"
            "3. Углеводы — топливо\n"
            "Перед тренировкой — углеводы. После — белок + углеводы.\n"
            "Крупы, картофель, фрукты — всё подходит.\n\n"
            "4. Жиры — не убирать\n"
            "Минимум 0.7–1 г/кг. Орехи, масло, рыба.\n\n"
            "5. Стабильность важнее идеала\n"
            "80% по плану каждый день лучше, чем 100% три дня и срыв.\n\n"
            "Открой раздел «Питание» — там готовые рационы под твои цифры."
        )
    },
    "faq:motivation": {
        ...
        "a": (
            ...
            "Мотивация нестабильна. Профессионалы не ждут её — они строят привычку.\n\n"
            "Почему бросают:\n"
            "— Ждали результата за 2–4 недели, не увидели\n"
            "— Программа слишком тяжёлая или скучная\n"
            "— Нет измеримого прогресса\n"
            "— Сравнение с другими\n\n"
            "Что работает:\n\n"
            "1. Снизь планку\n"
            "30 минут 3 раза в неделю стабильно лучше, чем 2 часа раз в две недели.\n\n"
            "2. Записывай прогресс\n"
            "Дневник тренировок: когда видишь рост в цифрах — мотивация возвращается.\n\n"
            "3. Делай замеры и фото\n"
            "Вес лжёт. Объёмы и фото — нет. Снимай раз в 4 недели.\n\n"
            "4. Фокус на процессе\n"
    ...
    "faq:sleep": {
        ...
        "a": (
            ...
            "Факты:\n"
            "— Меньше 6 часов: восстановление мышц хуже на 60%\n"
            "— Меньше 7 часов: повышен кортизол → хуже жиросжигание\n"
            "— 7–9 часов: оптимум для спортивного прогресса\n\n"
            "Признаки недовосстановления:\n"
            "— Усталость быстрее, чем раньше\n"
            "— Веса не растут несколько недель\n"
            "— Раздражительность или постоянная сонливость\n"
            "— Частые простуды\n\n"
            "Что делать:\n"
            "— Ложись в одно время\n"
            "— Час до сна — без яркого экрана\n"
            "— Прохладная комната (18–20°C) улучшает качество сна\n"
            "— При 5 тренировках в неделю: минимум 1 день полного отдыха"
        )
    },
    "faq:technique": {
        "q": "🏋️ Почему так важна техника?",
        "a": (
            "🏋️ Техника — почему это не второстепенно\n\n"
            ...
            "Правила:\n\n"
            "1. Техника важнее веса\n"
            "40 кг чисто лучше, чем 80 кг с читингом.\n\n"
            "2. Начинай с малого\n"
            "Первые 2–4 недели — техника без максимальных весов.\n\n"
            "3. Кнопка «Техника» под каждым упражнением\n"
            "Картинка + пошаговое описание + частые ошибки.\n\n"
            "4. RIR (запас повторений)\n"
            "Заканчивай подход, когда можешь сделать ещё 1–2 раза.\n"
            "Не до отказа — до технического предела.\n\n"
            "5. Боль в суставе — стоп. Жжение в мышце — ок."
        )
    },
    "faq:cardio": {
        "q": "🏃 Нужно ли кардио?",
        "a": (
            ...
            "Всё зависит от цели и объёма.\n\n"
            "Когда помогает:\n"
            "— Ускоряет дефицит без урезания еды\n"
            "— Улучшает сердечно-сосудистую систему\n"
            "— Лёгкое кардио ускоряет восстановление\n\n"
            "Когда мешает:\n"
            "— Много кардио на массе = тело сжигает мышцы\n"
            "— Сразу после силовой 40+ мин = хуже восстановление\n"
            "— Кардио вместо силовых = потеря мышц\n\n"
            "Рекомендации:\n\n"
            "На сушке:\n"
            "2–3 раза по 20–40 мин. LISS: ходьба, велосипед, лёгкий бег.\n"
            "Отдельный день или после силовой тренировки.\n\n"
            "На массе:\n"
            "1–2 раза по 20–30 мин — для здоровья сердца. Не больше."
        )
    },
}
...
async def open_upgrade(user_id: int, chat_id: int, bot: Bot, callback: Optional[CallbackQuery] = None):
    text = (
        ...
        "Платишь один раз, доступ без ограничений\n\n"
        f"🔥 3 месяца — {TARIFFS['t3']['price']}₽\n"
        "Тренировки + питание + дневник + замеры\n"
        "90 дней — оптимальный срок для видимого результата\n\n"
        f"📋 1 месяц — {TARIFFS['t1']['price']}₽\n"
        "Тренировки + дневник + замеры\n"
        "Базовый доступ на 30 дней\n\n"
        f"🟢 Пробный — {TARIFFS['trial']['price']}₽\n"
        "Символический доступ на 3 дня\n"
        "Тренировки и вопросы — чтобы убедиться, что всё работает"
    )
    ...
    if await is_access_active(uid):
        ...
        if tariff in FULL_ACCESS_TARIFFS:
            ...
            text = (
                ...
                "Хочешь питание, смену программы и полный доступ?\n"
                "Перейди на тариф 3 месяца или Навсегда."
            )
        ...
        text = (
            ...
            "Выбери тариф — откроется страница оплаты.\n"
            "Карта или ЮMoney. Доступ активируется автоматически."
        )
...
async def cb_build_program(callback: CallbackQuery, state: FSMContext, bot: Bot):
    ...
    text = (
        "Профиль готов.\n\n"
        "Выбери тариф — программа сформируется сразу после оплаты:\n\n"
        f"🏆 Навсегда — {TARIFFS['life']['price']}₽\n"
        "Тренировки + питание + дневник. Без ограничений по сроку.\n\n"
        f"🔥 3 месяца — {TARIFFS['t3']['price']}₽\n"
        "Тренировки + питание + дневник. 90 дней для стабильного результата.\n\n"
        f"🟢 Пробный доступ — {TARIFFS['trial']['price']}₽\n"
        "Символический доступ на 3 дня. Тренировки и вопросы — убедиться, что всё работает.\n\n"
        "Нажми кнопку ниже:"
    )
