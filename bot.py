...
TECH = {
    ...
    "row": {
        "title": "Отжимания (классика)",
        "mp4": "media/tech/pushup.mp4",
        "text": (
            "📚 Отжимания (классические)\n"
            "Зачем: грудь (средний пучок), трицепс, передние дельты, кор.\n\n"
            "✅ Настройка\n"
            "• Ладони под плечами или чуть шире — предплечья вертикально\n"
            "• Тело — прямая линия от головы до пяток\n"
            "• Пресс и ягодицы напряжены на протяжении всего подхода\n"
            "• Взгляд — вперёд и вниз, шея нейтральна\n\n"
            "✅ Выполнение по шагам\n"
            "1. Вдох перед опусканием\n"
            "2. Медленно (2–3 сек) опускайся, сохраняя прямую линию тела\n"
            "3. Локти под углом ~45° к корпусу (не в стороны на 90°)\n"
            "4. Грудь касается пола или почти касается — без отбива\n"
            "5. Короткая пауза внизу — не расслабляйся\n"
            "6. Выдох — жми пол руками, выжимай тело вверх как единое целое\n\n"
            "⚠️ Частые ошибки\n"
            "• Провал в пояснице → напряги пресс и ягодицы сильнее\n"
            "• Голова смотрит вниз → взгляд чуть вперёд\n"
            "• Таз поднят вверх (горка) → опусти бёдра\n"
            "• Рывок вверх → контроль важнее скорости\n"
            "• Неполная амплитуда → опускайся до груди\n\n"
            "💡 Подсказки\n"
            "Слишком тяжело → отжимайся от скамьи или подоконника.\n"
            "Слишком легко → пауза 3 сек внизу или ноги на возвышение.\n"
            "Акцент на грудь: расширь хват на 5–7 см."
        )
    },
    "latpulldown": {
    ...
    "hinge": {
        ...
        "text": (
            ...
            "✅ Настройка\n"
            "• Лягь на спину, лопатки прижаты к полу или скамье.\n"
            "• Колени согнуты, стопы на ширине бёдер, пятки под коленями.\n"
            "• Для отягощения: штанга/гантель лежит на тазу, придержи руками.\n\n"
            "✅ Как делать\n"
            "1) Вдох — напряги ягодицы ещё до начала движения.\n"
            "2) Выдох — поднимай таз до прямой линии бедро-корпус.\n"
            "3) Наверху — пауза 1–2 сек, максимально сожми ягодицы.\n"
            "4) Медленно опускай — 2 сек — не касаясь пола полностью.\n\n"
            "⚠️ Частые ошибки\n"
            "• Поясница прогибается в верхней точке → убери лишнюю высоту.\n"
            "• Работают квадрицепсы, не ягодицы → стопы чуть дальше от таза.\n"
            "• Колени разъезжаются → держи над носками всё время.\n\n"
            "💡 Прогрессия\n"
            "Свой вес → гантель на бёдрах → штанга → одна нога на весу."
        )
    },
    "core": {
        "title": "Планка",
    ...
    "pullup_chinup": {
        "title": "Подтягивания обратным хватом (зал)",
    ...
    "pushup_narrow": {
        ...
        "text": (
            ...
            "✅ Настройка\n"
            "• Руки на ширине плеч или чуть уже — акцент на трицепс.\n"
            "• Тело — прямая линия.\n\n"
            "✅ Как выполнять\n"
            "1) Локти держи прижатыми к корпусу при опускании.\n"
            "2) Опускайся до касания грудью пола.\n"
            "3) Выжимай вверх.\n\n"
            "⚠️ Частые ошибки\n"
            "• Локти уходят в стороны — прижимай к телу.\n"
            "• Таз задирается вверх — держи прямую линию.\n\n"
            "💡 Подсказка\n"
            "Лучшее упражнение на трицепс без инвентаря."
        )
    },
    "pike_pushup": {
    ...
    "pullup_chin": {
        ...
        "text": (
            "📚 Подтягивания обратным хватом (бицепс + широчайшие)\n\n"
            "✅ Настройка\n"
            "• Хват снизу — ладони смотрят на тебя, ширина плеч или чуть уже.\n"
            "• Повисни в полном вытяжении, плечи активны (не вис трупом).\n\n"
            "✅ Как выполнять\n"
            "1) Начни движение лопатками вниз — ещё до сгибания локтей.\n"
            "2) Тяни локти вниз вдоль корпуса.\n"
            "3) Подбородок выше перекладины — грудь тянется к ней.\n"
            "4) Медленно опускайся — 2–3 сек — до полного выпрямления.\n\n"
            "⚠️ Частые ошибки\n"
            "• Раскачка корпуса — держи кор и ягодицы напряжёнными.\n"
            "• Тянешь руками — подключай спину с первого сантиметра.\n"
            "• Неполная амплитуда — вниз до выпрямленных рук каждый раз.\n\n"
            "💡 Подсказка\n"
            "Самый доступный вид подтягиваний для новичков — обратный хват "
            "даёт преимущество бицепсу и чуть облегчает движение."
        )
    },
    "pullup_narrow": {
    ...
    "bulgarian_bw": {
        ...
        "text": (
            "📚 Болгарские приседания (квадрицепс + ягодицы)\n\n"
            "✅ Настройка\n"
            "• Задняя нога на возвышении (стул, диван), передняя впереди.\n"
            "• Передняя стопа под коленом или чуть дальше.\n\n"
            "✅ Как выполнять\n"
            "1) Опускай колено задней ноги к полу.\n"
            "2) Переднее колено не выходит за носок.\n"
            "3) Вставай через переднюю ногу.\n\n"
            "⚠️ Частые ошибки\n"
            "• Колено уходит внутрь — следи за траекторией.\n"
            "• Наклон вперёд — держи корпус вертикально.\n\n"
            "💡 Подсказка\n"
            "Отличная замена приседу — нагрузка на каждую ногу отдельно."
        )
    },
    "lunge_bw": {
        "title": "Выпады (свой вес)",
        "text": (
            "📚 Выпады — собственный вес (квадрицепс + ягодицы)\n\n"
            "✅ Настройка\n"
            "• Стань прямо, ноги вместе, руки на поясе или перед собой.\n"
            "• Шаг вперёд широкий — передняя стопа полностью на полу.\n\n"
            "✅ Как выполнять\n"
            "1) Шагни вперёд, сохраняй корпус вертикальным.\n"
            "2) Опускай заднее колено к полу — 1–2 см от пола.\n"
            "3) Переднее бедро параллельно полу, колено над носком.\n"
            "4) Оттолкнись передней ногой и вернись в исходное.\n\n"
            "⚠️ Частые ошибки\n"
            "• Переднее колено выходит за носок — шагай длиннее.\n"
            "• Корпус наклоняется вперёд — грудь расправь, взгляд прямо.\n"
            "• Слишком короткий шаг — заднее колено висит высоко, нет нагрузки.\n\n"
            "💡 Прогрессия\n"
            "Статичные → попеременные → обратные → болгарские → с гантелями."
        )
    },
    "glute_bridge": {
        "title": "Ягодичный мост (свой вес)",
        "text": (
            "📚 Ягодичный мост — домашняя версия (ягодицы)\n\n"
            "✅ Настройка\n"
            "• Лягь на спину, колени согнуты ~90°, стопы на ширине бёдер.\n"
            "• Пятки прямо под коленями — не дальше и не ближе.\n"
            "• Руки вдоль тела ладонями вниз для опоры.\n\n"
            "✅ Как выполнять\n"
            "1) Напряги ягодицы ещё до подъёма — активируй мышцы сразу.\n"
            "2) Подними таз — линия колено-таз-плечо прямая.\n"
            "3) Наверху — пауза 2 сек, сожми ягодицы максимально.\n"
            "4) Медленно опускай — пол почти касаешься, но не расслабляешься.\n\n"
            "⚠️ Частые ошибки\n"
            "• Поясница гиперразгибается вверху — убери высоту подъёма.\n"
            "• Стопы слишком далеко — работают квадрицепсы, не ягодицы.\n"
            "• Колени расходятся — положи между ними полотенце/мяч.\n\n"
            "💡 Прогрессия дома\n"
            "Двуногий → одна нога вытянута → одна нога на возвышении → медленный темп."
        )
    },
    "plank_bw": {
        "title": "Планка (свой вес)",
        "text": (
            "📚 Планка (кор — домашняя версия)\n\n"
            "✅ Настройка\n"
            "• Упор на предплечья, локти строго под плечами.\n"
            "• Тело — прямая линия: голова, спина, ягодицы, пятки на одном уровне.\n"
            "• Взгляд в пол, шея нейтральна.\n\n"
            "✅ Как выполнять\n"
            "1) Напряги пресс — будто ждёшь удар в живот.\n"
            "2) Сожми ягодицы и напряги квадрицепсы.\n"
            "3) Дыши ровно: вдох носом, выдох ртом, не задерживай.\n"
            "4) Держи столько, сколько можешь без потери формы.\n\n"
            "⚠️ Частые ошибки\n"
            "• Таз задирается — ты облегчаешь себе жизнь, но не тренируешь кор.\n"
            "• Поясница провисает — напряги пресс и подтяни таз чуть вперёд.\n"
            "• Шея напряжена — расслабь, взгляд в пол.\n\n"
            "💡 Прогрессия без оборудования\n"
            "20 сек → 30 сек → 45 сек → 60 сек → планка с подъёмом ноги."
        )
    },
    "leg_raise_lying_bw": {
        "title": "Подъём ног лёжа",
        "text": (
            "📚 Подъём ног лёжа (нижний пресс)\n\n"
            "✅ Настройка\n"
            "• Лягь на спину, руки вдоль тела или под поясницей.\n"
            "• Ноги прямые или слегка согнуты.\n\n"
            "✅ Как выполнять\n"
            "1) Подними ноги до вертикали (90°).\n"
            "2) Медленно опускай — не касаясь пола.\n"
            "3) Внизу — пауза, пресс напряжён.\n\n"
            "⚠️ Частые ошибки\n"
            "• Поясница отрывается — подложи руки под поясницу.\n"
            "• Ноги падают быстро — контролируй опускание.\n\n"
            "💡 Подсказка\n"
            "Чем медленнее опускание, тем сильнее нагрузка."
        )
    },
    "crunch_bw": {
        "title": "Скручивания",
        "text": (
            "📚 Скручивания (верхний пресс)\n\n"
            "✅ Настройка\n"
            "• Лягь на спину, колени согнуты, стопы на полу.\n"
            "• Руки за головой или на груди.\n\n"
            "✅ Как выполнять\n"
            "1) Подними плечи и лопатки от пола.\n"
            "2) В верхней точке — сожми пресс, пауза.\n"
            "3) Медленно опускай, не расслабляя пресс полностью.\n\n"
            "⚠️ Частые ошибки\n"
            "• Тянешь голову руками — шея напрягается.\n"
            "• Полный подъём корпуса — это уже не скручивание.\n\n"
            "💡 Подсказка\n"
            "Движение небольшое — главное сокращение пресса, не амплитуда."
        )
    },
    "pushup": {
        "title": "Отжимания",
        "text": (
            ...
            "✅ Настройка\n"
            "• Ладони чуть шире плеч, пальцы смотрят вперёд или чуть наружу.\n"
            "• Тело — прямая линия от головы до пяток.\n"
            "• Пресс и ягодицы напряжены на протяжении всего подхода.\n\n"
            "✅ Как выполнять\n"
            "1) Вдох — медленно опускай грудь к полу (2–3 сек).\n"
            "2) Локти под углом ~45° к корпусу, не строго в стороны.\n"
            "3) Грудь почти касается пола — без отбива.\n"
            "4) Выдох — выжимай пол руками до выпрямления рук.\n"
            "5) Наверху — не разгибай локти в «замок».\n\n"
            "⚠️ Частые ошибки\n"
            "• Таз провисает — напряги пресс и ягодицы сильнее.\n"
            "• Локти торчат в стороны 90° — прижимай ближе к телу.\n"
            "• Неполная амплитуда — касайся грудью пола каждый раз.\n\n"
            "💡 Прогрессия\n"
            "Отжимания с колен → классика → ноги на возвышении → на одной руке."
        )
    },
}
...
EXERCISE_TECH_MAP = [
    ...
    ("хакк", "hack_squat"),
    ("болгарские приседания", "bulgarian_bw"),   # ← домашнее — строго перед "болгар"
    ...
    ("выпады", "lunge_bw"),                        # ← домашнее — строго перед "выпад"
    ("выпад", "lunge"),
    ...
    ("приседания (собственный вес)", "squat_bw"),  # ← домашнее — строго перед fallback
    ("приседания на одной ноге", "squat_bodyweight"),
    ("планка (статика)", "core"),                  # ← зальная — строго перед "планка"
    ("планка", "plank_bw"),                        # ← домашнее
    ("подъём ног лёжа", "leg_raise_lying_bw"),     # ← домашнее
    ("скручивания", "crunch_bw"),                  # ← домашнее
    ...
    ("ягодичный мост на одной ноге", "hinge"),  # ← строго перед общим
    ...
    ("отжимания узким хватом", "pushup_narrow"),              # ← домашнее (трицепс)
    ...
    ("подтягивания обратным хватом", "pullup_chin"),       # ← домашнее
