...
TECH = {
    ...
    "squat_bw": {
        ...
        "mp4": "",  # → "media/tech/squat_bw.mp4"
        "text": (
            "📚 Приседания со своим весом (квадрицепс + ягодицы)\n\n"
            "✅ Настройка\n"
            "• Стопы чуть шире плеч, носки наружу 15–30°.\n"
            "• Руки вперёд или скрещены на груди — для баланса.\n\n"
            "✅ Как делать\n"
            "1) Таз назад и вниз одновременно.\n"
            "2) Колени по линии носков — не заваливай внутрь.\n"
            "3) Грудь смотрит вперёд, спина прямая.\n"
            "4) Глубина — бёдра параллельно полу или ниже.\n"
            "5) Вставай, выталкивая пол ногами.\n\n"
            "⚠️ Частые ошибки\n"
            "• Колени внутрь → думай «раздвигаю пол».\n"
            "• Пятки отрываются → ставь стопы шире или подложи под пятки.\n\n"
            "💡 Прогрессия\n"
            "Свой вес → гоблет-присед → присед со штангой."
        )
    },
    "bulgarian_dumbbell": {
        "title": "Болгарские выпады с гантелями",
        ...
        "text": (
            ...
            "1) Опускайся вертикально, заднее колено к полу.\n"
            "2) Переднее колено не выходит за носок.\n"
            "3) Корпус прямой, грудь вперёд.\n"
            "4) Выталкивайся передней ногой вверх.\n\n"
            "⚠️ Частые ошибки\n"
            "• Шаг слишком короткий → коленный сустав перегружается.\n"
            "• Корпус заваливается → держи гантели симметрично.\n\n"
            "💡 Подсказка\n"
            "Гантели дают свободу траектории — удобнее для отработки техники."
        )
    },
    "lunge_bw": {
        "title": "Выпады (свой вес)",
        "mp4": "",  # → "media/tech/lunge_bw.mp4"
        "text": (
            "📚 Выпады со своим весом (ноги + ягодицы)\n\n"
            "✅ Как делать\n"
            "1) Широкий шаг вперёд — переднее колено не за носком.\n"
            "2) Заднее колено опускается почти до пола.\n"
            "3) Оттолкнись передней ногой и вернись.\n"
            "4) Корпус прямой, руки на поясе или вперёд для баланса.\n\n"
            "⚠️ Частые ошибки\n"
            "• Корпус падает вперёд → держи грудь вертикально.\n"
            "• Маленький шаг → колено уходит далеко за носок.\n\n"
            "💡 Прогрессия\n"
            "Статичные выпады → выпады ходьбой → с гантелями → со штангой."
        )
    },
    "glute_bridge": {
        "title": "Ягодичный мост",
        ...
        "text": (
            "📚 Ягодичный мост (ягодицы + задняя поверхность бедра)\n\n"
            "✅ Настройка\n"
            "• Лечь на спину, колени согнуты, стопы на полу — близко к ягодицам.\n"
            "• Руки вдоль тела или на тазе (если со штангой — штанга на тазе).\n\n"
            "✅ Как делать\n"
            "1) Напряги ягодицы и оторви таз от пола.\n"
            "2) Поднимай до прямой линии плечи — колени.\n"
            "3) Пауза 1–2 сек вверху — максимально сожми ягодицы.\n"
            "4) Медленно опускай, не кладя таз полностью на пол.\n\n"
            "⚠️ Частые ошибки\n"
            "• Поясница перегибается → поднимай только до прямой линии.\n"
            "• Колени расходятся → держи их над носками.\n\n"
            "💡 Подсказка\n"
            "Пауза вверху решает всё — без неё ягодицы почти не работают."
        )
    },
    "glute_bridge_single": {
        "title": "Ягодичный мост на одной ноге",
        "mp4": "",  # → "media/tech/glute_bridge_single.mp4"
        "text": (
            "📚 Ягодичный мост на одной ноге (ягодицы — усиленная версия)\n\n"
            "✅ Настройка\n"
            "• Лечь на спину, одна нога согнута, другая — прямая или поднята.\n"
            "• Опорная стопа близко к ягодице.\n\n"
            "✅ Как делать\n"
            "1) Оттолкнись одной ногой — поднимай таз вверх.\n"
            "2) Тело от плеча до колена опорной ноги — прямая линия.\n"
            "3) Пауза 1–2 сек, сожми ягодицу опорной ноги.\n"
            "4) Медленно опускай.\n\n"
            "⚠️ Частые ошибки\n"
            "• Таз перекашивается → держи бёдра на одном уровне.\n"
            "• Поясница перегибается → не поднимай слишком высоко.\n\n"
            "💡 Прогрессия\n"
            "Двуногий мост → одноногий → одноногий с весом на тазе."
        )
    },
    "calves_machine": {
        "title": "Подъёмы на носки в тренажёре",
        ...
        "text": (
            "📚 Подъёмы на носки в тренажёре (икроножные)\n\n"
            "✅ Настройка\n"
            "• Плечи под подушками тренажёра, стопы на платформе.\n"
            "• Носки вперёд или слегка наружу.\n\n"
            "✅ Как делать\n"
            "1) Опусти пятки максимально вниз — растяжение икр.\n"
            "2) Плавно поднимайся на носки — максимально высоко.\n"
            "3) Пауза 1 сек наверху — сожми икры.\n"
            "4) Медленно опускай — 2–3 сек.\n\n"
            "⚠️ Частые ошибки\n"
            "• Пружинишь без амплитуды → нет растяжения и сокращения.\n"
            "• Слишком быстро → икры работают вхолостую.\n\n"
            "💡 Подсказка\n"
            "Полная амплитуда важнее большого веса — растяни икру внизу."
        )
    },
    "calves_standing": {
        "title": "Подъёмы на носки стоя",
        "mp4": "",  # → "media/tech/calves_standing.mp4"
        "text": (
            "📚 Подъёмы на носки стоя (икроножные без тренажёра)\n\n"
            "✅ Настройка\n"
            "• Встань на край ступеньки или возвышения, пятки свисают.\n"
            "• Опора руками для равновесия.\n\n"
            "✅ Как делать\n"
            "1) Опусти пятки ниже уровня носков — максимальное растяжение.\n"
            "2) Поднимайся на носки как можно выше — пауза 1 сек.\n"
            "3) Медленно опускай пятки вниз.\n\n"
            "⚠️ Частые ошибки\n"
            "• Нет опускания ниже носков → половина амплитуды → половина результата.\n"
            "• Пружинишь → добавь паузу внизу и вверху.\n\n"
            "💡 Прогрессия\n"
            "Две ноги → одна нога → одна нога с весом в руке."
        )
    },
    # ── ГРУДЬ ──────────────────────────────────────────────
    "bench_barbell": {
    ...
    "pushup_wide": {
        ...
        "mp4": "",  # → "media/tech/pushup_wide.mp4"
        "text": (
            "📚 Отжимания широким хватом (акцент на грудь)\n\n"
            "✅ Настройка\n"
            "• Ладони шире плеч на 15–20 см, пальцы чуть наружу.\n"
            "• Тело — прямая линия от головы до пяток, пресс напряжён.\n\n"
            "✅ Как делать\n"
            "1) Медленно опускай грудь между рук — 2–3 сек.\n"
            "2) Локти идут в стороны и назад — угол 45–75°.\n"
            "3) Грудь почти касается пола — полная амплитуда.\n"
            "4) Выжимай вверх, сводя грудь в верхней точке.\n\n"
            "⚠️ Частые ошибки\n"
            "• Таз провисает → напряги пресс и ягодицы.\n"
            "• Голова смотрит вверх → держи шею нейтрально.\n\n"
            "💡 Подсказка\n"
            "Думай «свожу грудь» — не «жму пол» — лучше чувствуешь мышцу."
        )
    },
    "pike_pushup": {
        "title": "Пайк отжимания",
        ...
        "text": (
            ...
            "✅ Настройка\n"
            "• Поза перевёрнутой V: таз высоко, ноги прямые, руки на полу.\n"
            "• Руки на ширине плеч, пальцы вперёд.\n\n"
            "✅ Как делать\n"
            "1) Сгибай локти — голова опускается к полу между рук.\n"
            "2) Локти идут в стороны — движение похоже на жим над головой.\n"
            "3) Голова почти касается пола — пауза.\n"
            "4) Выжимай вверх до исходной позы.\n\n"
            "⚠️ Частые ошибки\n"
            "• Таз опускается → потеря акцента на плечи.\n"
            "• Слишком узкая стойка → плохой угол для плеч.\n\n"
            "💡 Прогрессия\n"
            "Пайк от пола → пайк с ногами на возвышении → стойка у стены."
        )
    },
    "dips": {
    ...
    "pullup_narrow": {
        ...
        "mp4": "",  # → "media/tech/pullup_narrow.mp4"
        "text": (
            "📚 Подтягивания узким хватом (бицепс + нижняя часть широчайших)\n\n"
            "✅ Настройка\n"
            "• Хват уже плеч (10–15 см между ладоней), ладони к себе или нейтральный.\n"
            "• Вис на выпрямленных руках — плечи активны, не «трупом».\n\n"
            "✅ Как делать\n"
            "1) Тяни грудь к перекладине, сводя лопатки.\n"
            "2) Локти идут вниз и к телу — близко к корпусу.\n"
            "3) Подбородок выше перекладины — пауза.\n"
            "4) Медленно опускайся на прямые руки — 2–3 сек.\n\n"
            "⚠️ Частые ошибки\n"
            "• Раскачка корпусом → зафиксируй ноги, не помогай инерцией.\n"
            "• Не опускаешься полностью → теряешь амплитуду.\n\n"
            "💡 Подсказка\n"
            "Узкий хват даёт больше работы бицепсу — хорошо для руки+спина."
        )
    },
    # ── ПЛЕЧИ ──────────────────────────────────────────────
    "ohp_dumbbell_sitting": {
    ...
    "biceps_dumbbell": {
        ...
        "text": (
            "📚 Сгибания с гантелями (бицепс)\n\n"
            "✅ Настройка\n"
            "• Стой прямо, гантели в опущенных руках, ладони вперёд.\n"
            "• Локти прижаты к телу и зафиксированы — не двигаются.\n\n"
            "✅ Как делать\n"
            "1) Сгибай обе руки одновременно или попеременно.\n"
            "2) В верхней точке — гантели у плеч, пауза 1 сек.\n"
            "3) Медленно опускай до полного выпрямления — 2–3 сек.\n\n"
            "⚠️ Частые ошибки\n"
            "• Раскачка корпусом — снизь вес или делай сидя.\n"
            "• Локти уезжают вперёд — нет акцента на бицепс.\n\n"
            "💡 Вариации\n"
            "Ладони вперёд (бицепс) → нейтральный хват (молотки + брахиалис)."
        )
    },
    # ── ТРИЦЕПС ────────────────────────────────────────────
    "triceps_cable": {
    ...
    "planks_static": {
        ...
        "mp4": "",  # → "media/tech/planks_static.mp4"
        "text": (
            "📚 Планка статическая (кор — стабилизация)\n\n"
            "✅ Настройка\n"
            "• Упор на предплечья, локти строго под плечами.\n"
            "• Тело — прямая линия: голова, спина, ягодицы, пятки.\n"
            "• Взгляд в пол, шея нейтральна.\n\n"
