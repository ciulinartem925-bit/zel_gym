...
async def cb_nav(callback: CallbackQuery, state: FSMContext, bot: Bot):
    ...
    if key == "menu":
        ...
        if place in ("дома", "дом"):
            text = (
                "💪 <b>Как прогрессировать (дома)</b>\n\n"
                "1. Выбери упражнение (например: отжимания, подтягивания, приседания).\n\n"
                "2. Сделай 3 подхода.\n\n"
                "Пример:\n"
                "Отжимания\n"
                "12\n"
                "10\n"
                "8\n\n"
                "3. На следующей тренировке попробуй сделать на 1–2 повторения больше.\n\n"
                "Например:\n"
                "13\n"
                "11\n"
                "9\n\n"
                "4. Постепенно увеличивай общее количество повторений.\n\n"
                "5. Когда упражнение становится лёгким — усложни его:\n"
                "• добавь рюкзак с весом\n"
                "• делай медленнее\n"
                "• добавь ещё один подход\n"
                "• выбери более сложную вариацию\n\n"
                "📈 <b>Правило:</b>\n"
                "каждая тренировка = больше повторений или более сложный вариант упражнения."
            )
        else:
            text = (
                "💪 <b>Как прогрессировать (в зале)</b>\n\n"
                "1. Выбери вес, с которым можешь сделать 6–8 повторений.\n\n"
                "2. Сделай 3 подхода.\n\n"
                "Пример:\n"
                "80 кг × 8\n"
                "80 кг × 7\n"
                "80 кг × 6\n\n"
                "3. На следующей тренировке постарайся сделать на 1 повторение больше.\n\n"
                "Например:\n"
                "80 кг × 9\n"
                "80 кг × 8\n"
                "80 кг × 7\n\n"
                "4. Твоя цель — дойти до 10 повторений во всех подходах.\n\n"
                "5. Когда получилось 10 / 10 / 10 — увеличь вес на 2.5–5 кг и начни снова с 6–8 повторений.\n\n"
                "📈 <b>Правило:</b>\n"
                "каждая тренировка = либо больше повторений, либо больше вес."
            )
