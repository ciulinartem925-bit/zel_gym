...
def locked_text() -> str:
    return "Доступ закрыт.\nОплати тариф — кнопка 💳 Оплата/доступ внизу экрана."
...
FAQ_QUESTIONS = {
    "faq:weight": {
        ...
        "a": (
            ...
            "Почему так бывает:\n"
            "— Соусы, масло, перекусы не считаются\n"
            "  (один незамеченный перекус = 300–500 ккал)\n"
            "— Вес взвешивается в разное время\n"
            "  (норма: утром, натощак — тогда цифра объективна)\n"
            "— Мало белка → тело теряет мышцы, а не жир\n"
            "— Мало воды → задержка воды скрывает уход жира\n\n"
            "Пример:\n"
            "Если цель — похудеть, и вес стоит 2 недели,\n"
            "проверь: за 7 дней нет минус 0.3–0.5 кг?\n"
            "Снизь питание на 150–200 ккал и подожди ещё неделю.\n\n"
            "Что делать прямо сейчас:\n"
            "1. Взвешивай всю еду 7–14 дней подряд\n"
            "2. Взвешивайся утром натощак, 3–4 раза в неделю\n"
            "3. Смотри на среднее за неделю, а не на один день"
        )
    },
    "faq:muscle": {
        "q": "💪 Почему нет роста мышц?",
        "a": (
            "💪 Мышцы не растут — разбираем\n\n"
            "Короткий ответ: нет хотя бы одного из трёх —\n"
            "нагрузка / питание / восстановление.\n\n"
            "Частые причины:\n\n"
            "1. Нет прогрессии\n"
            "Одна программа месяцами → тело привыкло.\n"
            "Пример: жмёшь 60 кг уже 3 месяца?\n"
            "Добавь 2.5 кг или 1 повтор — мышца почувствует стимул.\n\n"
            "2. Мало белка\n"
            "На массу нужно 1.8–2.2 г/кг.\n"
            "При весе 75 кг → 135–165 г белка в день.\n\n"
            "3. Мало калорий\n"
            "На дефиците мышцы не растут. Нужен профицит +200–400 ккал.\n\n"
            "4. Плохой сон\n"
            "Менее 7 часов = гормон роста не выделяется нормально.\n\n"
            "Совет новичку:\n"
            "Первые 3–6 месяцев прогресс идёт быстро даже без идеального питания.\n"
            "Главное — регулярность и прогрессия весов."
        )
    },
    "faq:plateau": {
        ...
        "a": (
            "📉 Плато — как выйти?\n\n"
            "Короткий ответ: тело адаптировалось к нагрузке.\n"
            "Это нормально — происходит каждые 6–10 недель.\n\n"
            "Признаки плато:\n"
            ...
            "Что делать:\n\n"
            "1. Смени программу\n"
            "Кнопка «Составить новый план» в профиле — другой набор упражнений.\n\n"
            "2. Разгрузочная неделя\n"
            "-30% нагрузки, только техника.\n"
            "После — обычно идёт мощный прогресс.\n\n"
            "3. Проверь питание\n"
            "Незаметно выросли калории? Пересчитай рацион.\n\n"
            "Пример:\n"
            "Присед 80 кг стоит 4 недели?\n"
            "Попробуй 75 кг, добавь паузу 2 сек внизу — через 2 недели 82.5 пойдут легче.\n\n"
            "Плато 2–3 недели — норма. Больше месяца — нужно менять подход."
        )
    },
    "faq:diet": {
        ...
        "a": (
            ...
            "Короткий ответ: считай калории и белок.\n"
            "Остальное — детали.\n\n"
            "Основы:\n\n"
            "1. Калории — фундамент\n"
            "Похудение: дефицит 300–500 ккал.\n"
            "Масса: профицит 200–400 ккал.\n"
            "Пример: норма 2200 ккал → на сушке ешь 1700–1900.\n\n"
            "2. Белок — каждый день\n"
            "1.8–2 г/кг. При 70 кг → 126–140 г в день.\n"
            "Источники: курица, рыба, яйца, творог.\n\n"
            "3. Углеводы и жиры — не враги\n"
            "Не убирай жиры ниже 0.7 г/кг — упадут гормоны.\n"
            "Углеводы перед тренировкой = энергия.\n\n"
            "Практический совет:\n"
            "— Для начала: просто добавь белок к каждому приёму пищи\n"
            "— Для новичка: не нужна идеальная диета, нужна стабильная\n"
            "— Если пропустил тренировку: ешь как обычно, ничего страшного\n\n"
            "Открой «Питание» — там КБЖУ под твои параметры и примеры рационов."
        )
    },
    "faq:motivation": {
        ...
        "a": (
            ...
            "Короткий ответ: не полагайся на мотивацию.\n"
            "Строй привычку.\n\n"
            "Почему бросают:\n"
            "— Ждали результат за 2–4 недели — не увидели\n"
            "— Программа слишком тяжёлая\n"
            "— Нет видимого прогресса\n\n"
            "Что реально работает:\n\n"
            "1. Снизь планку\n"
            "3 тренировки по 40 мин стабильно лучше,\n"
            "чем 1 тренировка 2 часа раз в 2 недели.\n\n"
            "2. Отслеживай прогресс\n"
            "Дневник тренировок: рост в цифрах виден через 3–4 недели.\n"
            "Замеры: делай фото раз в 4 недели — вес лжёт, фото нет.\n\n"
            "3. Что делать, если пропустил тренировку?\n"
            "Ничего. Просто иди на следующую.\n"
            "Одна пропущенная тренировка не ломает прогресс.\n\n"
            "4. Реалистичные сроки\n"
            "Видимый результат: 8–12 недель при стабильной работе.\n"
            "Это не месяц — но и не годы."
        )
    },
    "faq:sleep": {
        ...
        "a": (
            ...
            "Короткий ответ: мышцы растут во сне, а не на тренировке.\n"
            "Тренировка — стимул. Сон — когда происходит рост.\n\n"
            "Факты:\n"
            "— 6 часов сна: восстановление мышц хуже на 60%\n"
            "— 7–9 часов: оптимум для прогресса\n"
            "— Хронический недосып: кортизол высокий → жир накапливается\n\n"
            "Как понять, что не восстанавливаешься:\n"
            "— Веса стоят 2–3 недели\n"
            "— На тренировке быстро устаёшь\n"
            "— Раздражительность или частые простуды\n\n"
            "Пример:\n"
            "Тренируешься 4 раза в неделю, спишь 5–6 часов?\n"
            "Попробуй 2 недели с нормальным сном — почти всегда\n"
            "веса начинают расти снова.\n\n"
            "Практически:\n"
            "— Ложись в одно время\n"
            "— Прохладная комната (18–20°C) улучшает качество сна\n"
            "— 1 полный день отдыха в неделю при 4–5 тренировках"
        )
    },
    "faq:technique": {
        ...
        "a": (
            ...
            "Короткий ответ: плохая техника = либо травма,\n"
            "либо нагрузка идёт не в ту мышцу.\n\n"
            "Реальные последствия:\n"
            "— Тянешь спиной вместо ног (присед)\n"
            "— Нагружаешь трапецию вместо широчайших (тяга)\n"
            "— Болят колени, плечи, поясница\n\n"
            "Пример для новичка:\n"
            "Первые 2–4 недели — работай с весом 50–60% от максимума.\n"
            "Освой технику → потом добавляй нагрузку.\n"
            "Это не потеря времени — это инвестиция в следующие годы.\n\n"
            "Что выбрать новичку:\n"
            "— Старт: присед, тяга верхнего блока, жим, отжимания\n"
            "— Используй кнопку «Техника» под каждым упражнением\n"
            "— Чисто с меньшим весом лучше, чем криво с большим\n\n"
    ...
    "faq:cardio": {
        ...
        "a": (
            ...
            "Зависит от цели.\n\n"
            "Когда помогает:\n"
            "— Сушка: ускоряет дефицит без урезания еды\n"
            "— Здоровье сердца: важно для всех\n"
            "— Лёгкое кардио ускоряет восстановление после силовой\n\n"
            "Когда мешает:\n"
            "— Много кардио на массе = тело жжёт мышцы\n"
            "— Сразу после силовой 40+ мин = хуже восстановление\n\n"
            "Примеры:\n\n"
            "Для сушки (3 тренировки/нед):\n"
            "2 кардио по 25–35 мин в отдельные дни.\n"
            "Ходьба 6–7 км/ч, велосипед, эллипс.\n\n"
            "Для массы:\n"
            "1–2 раза по 20 мин — только для здоровья.\n\n"
            "Совет новичку:\n"
            "Первые 2–3 месяца — фокус на силовые.\n"
            "Кардио добавляй после, когда база выстроена."
        )
    },
}
...
async def cmd_start(message: Message, bot: Bot):
    ...
    welcome_text = (
        ...
        "Как начать:\n"
        "1. Нажми ⚙️ Профиль — укажи цель, параметры, где тренируешься\n"
        "2. Выбери тариф (💳 Оплата) — программа сформируется сразу\n"
        "3. Открой 🏠 Меню — всё на месте: тренировки, питание, дневник\n\n"
        "Начнём?"
    )
