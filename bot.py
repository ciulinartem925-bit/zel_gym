...
TECH = {
    ...
    "pullup_chin": {
        ...
        "text": (
            ...
            "• Руки развёрнуты ладонями к себе.\n\n"
            "✅ Как выполнять\n"
            "1) Тяни локти вниз вдоль корпуса.\n"
            "2) Подтягивайся до подбородка выше перекладины.\n"
            "3) Медленно опускайся до полного выпрямления.\n\n"
            "⚠️ Частые ошибки\n"
            "• Раскачка — держи кор напряжённым.\n"
            "• Неполная амплитуда — до конца вниз.\n\n"
            "💡 Подсказка\n"
            "Обратный хват легче классики — хорошо подходит новичкам."
        )
    },
    "pullup_narrow": {
    ...
    "plank_bw": {
        ...
        "text": (
            "📚 Планка (кор)\n\n"
            "✅ Настройка\n"
            "• Упор на предплечья, тело — прямая линия.\n"
            "• Локти под плечами, взгляд в пол.\n\n"
            "✅ Как выполнять\n"
            "1) Напряги пресс, ягодицы и квадрицепсы.\n"
            "2) Не давай тазу провисать или задираться.\n"
            "3) Дыши равномерно, не задерживай дыхание.\n\n"
            "⚠️ Частые ошибки\n"
            "• Таз вверх — снизь время, держи ровно.\n"
            "• Поясница прогибается — напряги пресс сильнее.\n\n"
    ...
    "bulgarian_bw": {
        "title": "Болгарские приседания",
        "text": (
            "📚 Болгарские приседания — свой вес (квадрицепс + ягодицы)\n\n"
            "✅ Настройка\n"
            "• Задняя нога на диване или стуле (подъём стопы).\n"
            "• Передняя нога — широкий шаг вперёд, руки на поясе.\n\n"
            "✅ Как выполнять\n"
            "1) Медленно опускай тело вертикально вниз.\n"
            "2) Заднее колено идёт к полу — 1–2 см от пола.\n"
            "3) Переднее бедро параллельно полу в нижней точке.\n"
            "4) Вставай через переднюю ногу, не качайся.\n\n"
            "⚠️ Частые ошибки\n"
            "• Шаг слишком короткий — колено заходит за носок.\n"
            "• Корпус наклоняется вперёд — расправь грудь.\n"
            "• Задняя нога помогает — вся работа только в передней.\n\n"
            "💡 Прогрессия\n"
            "Свой вес → гантели в руках → штанга на плечах."
        )
    },
    "glute_bridge_single": {
    ...
    "pullup_wide_gym": {
        ...
        "text": (
            "📚 Подтягивания широким хватом — зал (широчайшие)\n\n"
            "✅ Настройка\n"
            "• Хват сверху шире плеч — примерно на ширину развёрнутых локтей.\n"
            "• Тело слегка отклонено назад, грудь вперёд.\n"
            "• Плечи активны — не вис трупом, лопатки слегка сведены.\n\n"
            "✅ Как выполнять\n"
            "1) Начни с опускания лопаток вниз — ещё до сгибания локтей.\n"
            "2) Тяни локти вниз и к рёбрам.\n"
            "3) Грудь тянется к перекладине, подбородок выше неё.\n"
            "4) Медленно опускайся 2–3 сек до полного вытяжения рук.\n\n"
            "⚠️ Частые ошибки\n"
            "• Тянешь только руками — спина не включается.\n"
            "• Раскачка — кор и ягодицы напряжены всё время.\n"
            "• Хват слишком широкий — дискомфорт в плечах, сузь.\n\n"
            "💡 Подсказка\n"
            "Пауза 1 сек вверху с грудью у перекладины — максимум нагрузки на спину."
        )
    },
    "rear_delt_machine": {
    ...
    "french_press_dumbbell": {
        ...
        "text": (
            "📚 Французский жим с гантелями лёжа (трицепс)\n\n"
            "✅ Настройка\n"
            "• Лягь на скамью, гантели над грудью, руки вертикально вверх.\n"
            "• Локти на ширине плеч, смотрят строго в потолок.\n\n"
            "✅ Как выполнять\n"
            "1) Сгибай локти, опуская гантели к вискам.\n"
            "2) Локти строго вверх — не расходятся в стороны.\n"
            "3) Гантели у ушей внизу — пауза 1 сек, трицепс растянут.\n"
            "4) Разгибай локти до прямых рук вверх.\n\n"
            "⚠️ Частые ошибки\n"
            "• Локти расходятся в стороны — следи в зеркало или попроси страховку.\n"
            "• Плечи двигаются — фиксируй плечо, работает только предплечье.\n"
            "• Гантели опускаешь за голову — это другое упражнение.\n\n"
            "💡 Плюс гантелей vs штанга\n"
            "Независимые руки — меньше стресса на запястья, легче держать форму."
        )
    },
    "triceps_oh_single": {
        "title": "Разгибание гантели из-за головы",
        "text": (
            "📚 Разгибание одной гантели из-за головы (длинная головка трицепса)\n\n"
            "✅ Настройка\n"
            "• Держи одну гантель двумя руками за верхний блин.\n"
            "• Руки подняты над головой, локти смотрят вперёд и вверх.\n"
            "• Можно стоя или сидя — сидя стабильнее.\n\n"
            "✅ Как выполнять\n"
            "1) Медленно сгибай локти — гантель опускается за голову.\n"
            "2) Локти неподвижны — двигаются только предплечья.\n"
            "3) Растяни трицепс внизу — пауза 1 сек.\n"
            "4) Разгибай до прямых рук вверх.\n\n"
            "⚠️ Частые ошибки\n"
            "• Локти расходятся в стороны — удерживай узко над головой.\n"
            "• Плечи и шея напрягаются — расслабь верх, работает только трицепс.\n"
            "• Слишком тяжёлый вес — теряешь форму, локти уходят.\n\n"
            "💡 Подсказка\n"
            "Длинная головка лучше растягивается здесь — ключ к объёму трицепса."
        )
    },
    "crossover_chest": {
        "title": "Кроссовер",
...
EXERCISE_TECH_MAP = [
    ...
    ("болгарские приседания", "bulgarian_bw"),       # ← домашнее
    ("выпады", "lunge_bw"),                          # ← домашнее (свой вес)
    ...
    ("подтягивания (широкий хват)", "pullup_wide_gym"),
    ...
    ("французский жим с гантелями", "french_press_dumbbell"),       # ← название из пула → triceps_oh
