...
TECH = {
    ...
    "hyperext_floor": {
        ...
        "text": (
            "📚 Гиперэкстензия на полу (поясница + ягодицы — без тренажёра)\n\n"
            "✅ Настройка\n"
            "• Лечь лицом вниз, руки вдоль тела или скрестить за голову.\n"
            "• Ноги вместе или чуть разведены, носки смотрят в пол.\n"  
            "• Тренажёр не нужен — упражнение выполняется на коврике.\n\n"
            "✅ Как делать\n"
            "1) Напряги ягодицы и поднимай грудь от пола — только силой мышц спины.\n"
            "2) Поднимайся до прямой линии тела — не выше, без переразгиба.\n"
            "3) Пауза 1–2 сек вверху — сожми ягодицы и поясницу.\n"
            "4) Медленно опускайся — 2–3 сек. Не касайся грудью пола полностью.\n\n"
            "⚠️ Частые ошибки\n"
            "• Поднимаешься слишком высоко → переразгиб поясницы, стоп на прямой линии.\n"
            "• Помогаешь руками или рывок шеей → руки лишь слегка касаются головы.\n"
            "• Слишком быстро → теряется нагрузка, делай медленно с паузой вверху.\n\n"
            "💡 Усложнение\n"
            "Руки вдоль тела → руки за голову → гантель у груди → Superman (руки и ноги одновременно)."
        )
    },
    "legcurl": {
        "title": "Сгибания ног",
    ...
    "bodyweight_hands_up_pushup": {
        ...
        "text": (
            "📚 Bodyweight Hands Up Push Ups (грудь + плечи + кор)\n\n"
            "✅ Настройка\n"
            "• Упор лёжа: ладони чуть шире плеч, ноги чуть шире обычного — для баланса.\n"
            "• Пресс и ягодицы напряжены — тело образует прямую линию от головы до пяток.\n\n"
            "✅ Как делать\n"
            "1) Опустись вниз — грудь почти касается пола, медленно (2 сек).\n"
            "2) Выжми себя вверх — в верхней точке подними одну руку строго вверх над головой.\n"
            "3) Зафиксируй 1 сек: рука прямая, смотрит в потолок, корпус не вращается.\n"
            "4) Верни руку на пол — сразу следующее отжимание.\n"
            "5) Чередуй руки каждое повторение.\n\n"
            "⚠️ Частые ошибки\n"
            "• Корпус разворачивается вслед за рукой → держи плечи параллельно полу.\n"
            "• Таз поднимается при подъёме руки → напряги пресс и ягодицы сильнее.\n"
            "• Рука идёт вперёд, а не вверх → тяни строго в потолок.\n"
            "• Слишком быстро → без контроля теряется смысл упражнения.\n\n"
            "💡 Прогрессия\n"
            "Обычные отжимания → Hands Up без фиксации → с фиксацией 2–3 сек → T-отжимание (поворот корпуса 90°)."
        )
    },
    # ── СПИНА ──────────────────────────────────────────────
    # ── ПЛЕЧИ ──────────────────────────────────────────────
