...
TECH = {
    ...
    "deadlift": {
        ...
        "text": (
            ...
            "• Гриф над серединой стопы, хват чуть шире бёдер.\n"
            "• Лопатки опусти вниз и назад.\n\n"
            "✅ Как делать\n"
            "1) Вдох, напряги корпус — «живот в тонусе».\n"
            "2) Толкай пол ногами, одновременно разгибая спину.\n"
            "3) Гриф идёт строго вертикально, близко к ногам.\n"
            "4) Наверху — бёдра вперёд, без перегиба поясницы.\n"
            "5) Опускай так же под контролем.\n\n"
            "⚠️ Частые ошибки\n"
            "• Округление поясницы → снизь вес.\n"
            "• Гриф отходит от ног → тяни к себе.\n"
            "• Рывок с пола → плавный старт с контролем.\n\n"
            "💡 Важно\n"
            "Начинай с лёгкого веса и идеальной техники."
        )
    },
    "barbell_row": {
...
def profile_edit_field_kb(u: dict) -> InlineKeyboardMarkup:
    ...
    rows = [
        ...
        [InlineKeyboardButton(text="🚀 Сгенерировать новый план", callback_data="p:rebuild_plan")],
...
def get_tech_key_for_exercise(name: str) -> Optional[str]:
    ...
    if any(x in n for x in ["трицепс", "разгибан"]):
        return "triceps"
    if any(x in n for x in ["пресс", "планк", "скручив", "подъём ног"]):
        return "core"
...
def generate_workout_plan(goal: str, place: str, exp: str, freq: int, limits: str, user_id: int = 0) -> Tuple[str, dict]:
    ...
    if is_gym:
        ...
        SQUAT = [
            "Присед со штангой",           # БАЗА — всегда включён
            "Жим ногами в тренажёре",
            "Гоблет-присед с гантелей",
            "Хакк-присед в тренажёре",
            "Присед с гантелями (Goblet)",
            "Болгарские выпады с гантелями",
            "Выпады с гантелями (ходьба)",
        ]
        HINGE = [
            "Румынская тяга со штангой",   # БАЗА
            "Становая тяга (техника)",      # БАЗА
        ...
        HPUSH = [
            "Жим штанги лёжа",             # БАЗА — приоритет
            "Жим гантелей лёжа",           # БАЗА
            "Жим штанги под углом (incline)",
            "Жим в тренажёре (грудь)",
            "Сведения в кроссовере (грудь)",
            "Жим гантелей под углом (incline)",
            "Отжимания с весом (жилет/блин)",
        ]
        HPULL = [
            ...
            "Тяга Т-грифа",
            "Тяга в тренажёре (грудь упор)",
            "Тяга нижнего блока параллельным хватом",
        ]
        VPULL = [
            "Подтягивания (широкий хват)", # БАЗА
            "Подтягивания нейтральным хватом",
            "Верхний блок широким хватом",
            "Верхний блок узким хватом",
            "Тяга верхнего блока параллельным хватом",
        ]
        VPUSH = [
            "Жим штанги стоя (overhead press)",  # БАЗА
            "Армейский жим",                      # БАЗА
            "Жим гантелей стоя/сидя",
            "Жим в тренажёре вверх",
        ]
        SHOULD = [
            "Разведения гантелей в стороны",
            "Face pull на блоке (канат)",
            "Задняя дельта в тренажёре (pec deck)",
            "Разведения гантелей в наклоне (задняя дельта)",
            "Тяга штанги к подбородку (широкий хват)",
        ]
        BI = [
            "Сгибания гантелей стоя",
            "Сгибания на блоке (нижний)",
            "Молотки с гантелями",
            "Сгибания на скамье Скотта",
            "Концентрированные сгибания",
        ]
        TRI = [
            "Разгибания на верхнем блоке (прямая рукоять)",
            "Разгибания на блоке (канат, одной рукой)",
        ...
        CALVES = [
            ...
            "Подъёмы на носки с гантелями (одна нога)",
        ]
        CORE = [
            "Планка (статика)",
            "Скручивания на блоке",
            "Подъёмы ног в висе",
            "Подъёмы ног в упоре на локтях",
            "Ролик для пресса (ab wheel)",
        ]
    else:
        # --- ДОМА: пулы с ОБЯЗАТЕЛЬНЫМИ базовыми упражнениями ---
        SQUAT = [
            "Приседания (собственный вес)",  # БАЗА
            "Присед с паузой внизу",
            "Присед сумо",
            "Болгарские выпады (нога на стуле)",
            "Выпады на месте",
            "Выпады ходьбой",
            "Приседания на одной ноге (пистолет, облегчённо)",
        ]
        HINGE = [
            "Ягодичный мост",               # БАЗА
            "Ягодичный мост на одной ноге",
            "Гиперэкстензия на полу",
            "Good-morning (без веса, техника)",
            "Румынская тяга с гантелями (если есть)",
        ]
        HPUSH = [
            "Отжимания (классика)",          # БАЗА — всегда
            "Отжимания с паузой 2 сек",
            "Отжимания узкие (трицепс)",     # БАЗА для трицепса
            "Отжимания от возвышения (ноги на стуле)",
            "Отжимания с хлопком (взрывные)",
        ]
        HPULL = [
            "Горизонтальные подтягивания (под столом)",  # БАЗА
            "Тяга резинки к поясу",
            "Тяга гантели одной рукой (в наклоне)",
            "Тяга резинки в наклоне",
        ]
        VPULL = [
            "Подтягивания (обратный хват)",  # БАЗА
            "Подтягивания (прямой хват)",    # БАЗА
            "Негативные подтягивания",
            "Тяга резинки сверху",
            "Подтягивания на петлях (TRX-стиль)",
        ]
        VPUSH = [
            "Пайк-отжимания",               # БАЗА для плеч дома
            "Жим резинки вверх (стоя)",
            "Отжимания (ноги высоко на стуле)",
        ]
        SHOULD = [
            "Разведения гантелей в стороны",
        ...
        TRI = [
            "Отжимания узкие",
            "Разгибание гантели из-за головы",
            "Обратные отжимания от стула/лавки",
        ]
        CALVES = [
        ...
        CORE = [
            ...
            "Скручивания на полу",
            "Подъёмы ног лёжа",
            "Велосипед (скручивания с поворотом)",
...
FAQ_QUESTIONS = {
    "faq:weight": {
        ...
        "a": (
            "⚖️ Вес стоит на месте — что происходит?\n\n"
            "Главная причина в 95% случаев — ты ешь ровно столько, сколько тратишь. "
            "Или думаешь, что ешь мало, но на самом деле нет.\n\n"
            "🔍 Проверь:\n"
            "1. Считаешь ли ты калории РЕАЛЬНО — с маслом, соусами, перекусами?\n"
            "   Один незамеченный перекус = 300–500 ккал. Это твой дефицит за день.\n\n"
            "2. Взвешиваешься ли ты утром, натощак, после туалета?\n"
            "   Вес колеблется на 1–3 кг в течение дня — не паникуй из-за одной цифры.\n\n"
            "3. Достаточно ли белка? Без белка тело теряет мышцы, а не жир.\n"
            "   Норма: 1.8–2.2 г на кг веса.\n\n"
            "4. Пьёшь ли воду? 2–3 литра в день.\n"
            "   Задержка воды маскирует потерю жира неделями.\n\n"
            "💡 Что делать:\n"
            "• Купи кухонные весы — взвешивай ВСЁ что ешь 2 недели подряд\n"
            "• Сравни цифру в конце с началом — если нет минус 0.5–1 кг, снизь на 200 ккал\n"
            "• Запасись терпением: жир уходит медленно, но уходит"
        )
    },
    "faq:muscle": {
        "q": "💪 Почему нет роста мышц?",
        "a": (
            "💪 Мышцы не растут — разбираем причины\n\n"
            "Рост мышц требует трёх вещей: нагрузка + питание + восстановление. "
            "Если нет хоть одного — роста нет.\n\n"
            "🔍 Частые ошибки:\n\n"
            "1. Нет прогрессии нагрузки\n"
            "   Делаешь одно и то же месяцами → тело адаптировалось.\n"
            "   Решение: каждые 1–2 недели добавляй вес или повторения.\n\n"
            "2. Мало белка\n"
            "   Менее 1.6 г на кг = мышцы не из чего строить.\n"
            "   На массу нужно 1.8–2.2 г/кг.\n\n"
            "3. Мало калорий\n"
            "   На дефиците мышцы расти не будут. Для массы нужен +200–400 ккал к норме.\n\n"
            "4. Плохой сон\n"
            "   Гормон роста выделяется ночью. Меньше 7 часов = медленный прогресс.\n\n"
            "5. Слишком много кардио\n"
            "   Кардио каждый день + дефицит = тело жжёт мышцы как топливо.\n\n"
            "💡 Правило: если 3 недели не растёт вес на штанге — меняй программу или питание."
        )
    },
    "faq:plateau": {
        "q": "📉 Почему прекратился прогресс (плато)?",
        "a": (
            "📉 Плато в тренировках — как выйти?\n\n"
            "Плато — нормальная часть процесса. "
            "Тело умное: оно адаптируется к нагрузке примерно за 6–8 недель.\n\n"
            "🔍 Причины плато:\n"
            "• Одна и та же программа больше 2–3 месяцев\n"
            "• Нет прогрессии веса/повторений\n"
            "• Нарушен режим питания (незаметно выросли калории)\n"
            "• Накопилась усталость — нужна разгрузочная неделя\n\n"
            "💡 Способы выйти из плато:\n"
            "1. Поменяй программу — используй кнопку 🔄 Сменить программу\n"
            "2. Возьми разгрузочную неделю: -30–40% нагрузки, только техника\n"
            "3. Добавь 100–200 ккал в рацион, если стоишь давно\n"
            "4. Смени порядок упражнений или добавь суперсеты\n"
            "5. Улучши сон: 7–9 часов — не пожелание, а требование\n\n"
            "⏳ Плато на 2–3 недели — это нормально. "
            "Плато больше месяца — сигнал что-то менять."
        )
    },
    "faq:diet": {
        "q": "🍽 Как правильно питаться для результата?",
        "a": (
            "🍽 Питание для результата — главные принципы\n\n"
            "Не нужно идеальной диеты. Нужно стабильного дефицита или профицита.\n\n"
            "📌 Основы:\n\n"
            "1. Калории решают всё\n"
            "   Похудение = дефицит 300–500 ккал. Масса = профицит 200–400 ккал.\n"
            "   Всё остальное — детали.\n\n"
            "2. Белок — главный приоритет\n"
            "   Минимум 1.6 г на кг веса. Лучше 2 г.\n"
            "   Источники: курица, рыба, яйца, творог, говядина.\n\n"
            "3. Углеводы — топливо для тренировок\n"
            "   Перед тренировкой — углеводы. После — белок + углеводы.\n"
            "   Крупы, картофель, фрукты — ок.\n\n"
            "4. Жиры — гормоны и суставы\n"
            "   Не убирай совсем. Минимум 0.7–1 г на кг.\n"
            "   Орехи, масло, рыба.\n\n"
            "5. Стабильность важнее идеальности\n"
            "   80% по плану стабильно > 100% идеально 3 дня и срыв.\n\n"
            "💡 Открой 🍽 Моё питание — там готовые примеры рационов под твои цифры."
        )
    },
    "faq:motivation": {
        ...
        "a": (
            ...
            "Мотивация — ненадёжная штука. "
            "Профессионалы не ждут мотивации — они создают привычку.\n\n"
            "🔍 Почему люди бросают:\n"
            "• Ожидали быстрого результата (2–4 недели) — не увидели\n"
            "• Программа слишком сложная или скучная\n"
            "• Нет измеримого прогресса\n"
            "• Сравнивают себя с другими\n\n"
            "💡 Что реально работает:\n\n"
            "1. Снизь планку\n"
            "   Лучше 30 минут 3 раза в неделю стабильно, чем 2 часа раз в две недели.\n\n"
            "2. Записывай прогресс\n"
            "   Используй 📓 Дневник — когда видишь рост в цифрах, мотивация возвращается.\n\n"
            "3. Делай замеры\n"
            "   Вес тела лжёт. Объёмы и фото не врут. "
            "   Делай фото каждые 4 недели.\n\n"
            "4. Фокус на процессе, не результате\n"
            "   Цель: 'прийти на тренировку', а не 'похудеть на 10 кг'.\n\n"
            "5. Реалистичные сроки\n"
            "   Видимый результат: 8–12 недель при стабильности. "
            "   Если ждёшь за месяц — будет разочарование."
        )
    },
    "faq:sleep": {
        "q": "😴 Почему важен сон и восстановление?",
        "a": (
            "😴 Сон и восстановление — недооценённый фактор\n\n"
            "Мышцы растут НЕ на тренировке. Они растут ВО СНЕ.\n"
            "Тренировка — это стимул. Сон — это когда происходит рост.\n\n"
            "📌 Факты:\n"
            "• Меньше 6 часов сна = на 60% хуже восстановление мышц\n"
            "• Меньше 7 часов = повышенный кортизол (гормон стресса) → хуже жиросжигание\n"
            "• 7–9 часов = оптимум для спортивного прогресса\n\n"
            "🔍 Признаки недовосстановления:\n"
            "• Ты устаёшь быстрее чем раньше\n"
            "• Веса не растут несколько недель\n"
            "• Постоянно хочется спать или раздражительность\n"
            "• Частые простуды\n\n"
            "💡 Что делать:\n"
            "• Ложись в одно время — цикломеланин важен\n"
            "• За час до сна без яркого экрана\n"
            "• Комната прохладная (18–20°C) — лучший сон\n"
            "• При 5 тренировках в неделю — хотя бы 1 день полного отдыха"
        )
    },
    "faq:technique": {
        "q": "🏋️ Почему так важна техника?",
        "a": (
            "🏋️ Техника упражнений — почему это важно\n\n"
            "Плохая техника = либо травма, либо нагрузка идёт не туда куда надо.\n\n"
            "📌 Реальные последствия плохой техники:\n"
            "• Качаешь трапецию вместо широчайших (тяга)\n"
            "• Нагрузка уходит в поясницу вместо ягодиц (присед)\n"
            "• Болят суставы — плечи, колени, локти\n"
            "• Через год — хроническая травма\n\n"
            "💡 Правила:\n\n"
            "1. Техника > вес\n"
            "   Лучше 40 кг чисто, чем 80 кг с читингом.\n\n"
            "2. Начинай с малого\n"
            "   Первые 2–4 недели — только техника без больших весов.\n\n"
            "3. Используй кнопку 📚 Техника в каждом упражнении\n"
            "   Там подробно с картинкой — как делать и что не делать.\n\n"
            "4. RIR (Reps In Reserve)\n"
            "   Заканчивай подход когда можешь сделать ещё 1–2 повторения.\n"
            "   Не до отказа — до технического отказа.\n\n"
            "5. Боль ≠ эффективность\n"
            "   Боль в суставах — стоп. Жжение в мышце — ок."
        )
    },
    "faq:cardio": {
        "q": "🏃 Нужно ли кардио?",
        "a": (
            "🏃 Кардио — нужно ли и сколько?\n\n"
            "Кардио не обязательно для похудения, но помогает. "
            "Всё зависит от цели.\n\n"
            "📌 Когда кардио помогает:\n"
            "• Ускоряет дефицит калорий без урезания еды\n"
            "• Улучшает сердечно-сосудистую систему\n"
            "• Ускоряет восстановление между тренировками (лёгкое кардио)\n\n"
            "⚠️ Когда кардио мешает:\n"
            "• Слишком много кардио на массе = тело жжёт мышцы\n"
            "• После силовой сразу 40+ мин кардио = хуже восстановление\n"
            "• Кардио заменяет силовые = потеря мышц\n\n"
            "💡 Рекомендации:\n\n"
            "На сушке:\n"
            "• 2–3 кардио по 20–40 мин в неделю\n"
            "• LISS (низкоинтенсивное): ходьба, велосипед, лёгкий бег\n"
            "• В отдельный от силовой день или после неё\n\n"
            "На массе:\n"
            "• 1–2 лёгкие кардио в неделю для здоровья сердца\n"
            "• Не больше 20–30 мин"
        )
    },
}
...
def faq_kb():
    rows = [
        ...
        [InlineKeyboardButton(text="📉 Прогресс остановился", callback_data="faq:plateau")],
        [InlineKeyboardButton(text="🍽 Как правильно питаться", callback_data="faq:diet")],
        [InlineKeyboardButton(text="😔 Нет мотивации", callback_data="faq:motivation")],
        [InlineKeyboardButton(text="😴 Сон и восстановление", callback_data="faq:sleep")],
        [InlineKeyboardButton(text="🏋️ Зачем нужна техника", callback_data="faq:technique")],
...
async def open_faq(user_id: int, chat_id: int, bot: Bot, callback: Optional[CallbackQuery] = None):
    text = (
        "❓ Ответы на вопросы\n\n"
        "Здесь разобраны самые частые причины, почему нет результата.\n"
        "Выбери тему 👇"
    )
    if callback:
...
async def cb_faq_question(callback: CallbackQuery, bot: Bot):
    ...
    text = (
        ...
        "1️⃣ Заполни профиль (кнопка ⚙️ Профиль снизу) — цель, параметры, где тренируешься\n"
        "2️⃣ Выбери тариф (💳 Оплата) — бот сразу сформирует твою программу\n"
        "3️⃣ Открой 🏋️ Тренировки — там все дни с упражнениями и кнопкой техники\n"
        "4️⃣ После тренировки заполняй 📓 Дневник — отмечай веса и повторения\n"
        "5️⃣ Следи за прогрессом в 📏 Замеры — вес тела, обхваты раз в 1–2 недели\n"
        "6️⃣ Питание 🍽 — персональный расчёт КБЖУ + готовые примеры рационов\n\n"
        "❓ Нет результата? Нажми «Ответы на вопросы» — разбираю частые ошибки.\n\n"
        "Выбери раздел 👇"
    )
...
async def cmd_start(message: Message, bot: Bot):
    ...
    welcome_text = (
        ...
        "• Показываю технику упражнений с картинками — под каждым упражнением кнопка 📚\n"
        "• Отвечаю на частые вопросы — почему нет прогресса, как питаться, как не бросить\n\n"
        "📋 Как начать:\n"
        "1️⃣ Нажми ⚙️ Профиль (кнопка снизу) — заполни цель, параметры, место тренировок\n"
        "2️⃣ Выбери тариф (💳 Оплата) — бот сразу сформирует твою персональную программу\n"
        "3️⃣ Открой 🏠 Меню — там все разделы: тренировки, питание, дневник, замеры\n\n"
...
async def cb_profile_edit(callback: CallbackQuery, state: FSMContext):
    ...
    text = (
        ...
        "После изменений нажми 🚀 Сгенерировать новый план."
    )
...
async def open_diary(user_id: int, chat_id: int, bot: Bot, state: FSMContext, callback: Optional[CallbackQuery] = None):
    ...
    text = (
        "📓 Дневник тренировок\n\n"
        "📌 Как вести дневник:\n"
        "• Выбирай упражнение кнопкой ниже\n"
        "• Вводи подходы в формате: вес×повторы\n"
        "  Пример: 60x8, 62x8, 65x6\n"
        "• Дату ставлю автоматически\n\n"
        "❓ Почему здесь не все упражнения?\n"
        "Дневник содержит базовые упражнения для отслеживания прогресса — "
        "именно по ним легче всего видеть рост силы. "
        "Тренируй все упражнения из программы, а в дневник записывай ключевые — "
        "жим, присед, тягу, подтягивания. "
        "Прогресс в базе = прогресс во всём остальном.\n\n"
        "💡 Совет: записывай каждую тренировку — "
        "через 4–8 недель увидишь рост в цифрах 💪"
    )
    if callback:
