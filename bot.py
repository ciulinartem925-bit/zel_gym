...
async def show_main_menu(bot: Bot, chat_id: int, user_id: int):
    text = (
        ...
        "• посчитаю твои КБЖУ и распределю их на белки, жиры и углеводы\n"
        "• сделаю лёгкое, а г удобное питание\n"
        "• так же можешь легко отслеживать свой прогресс с помощью встроенного дневника тренировок\n\n"
        "Выбирай, куда пойдём 👇\n\n"
