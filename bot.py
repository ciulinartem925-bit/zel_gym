...
FOOD_DB = {
    # Крупы и углеводы (данные: FatSecret, ккал = Б×4 + Ж×9 + У×4)
    "oats":      {"name": "Овсянка (сухая)",                "kcal": 395, "p": 16.9, "f": 6.9,  "c": 66.3},
    "rice":      {"name": "Рис белый (сухой)",              "kcal": 356, "p": 7.1,  "f": 0.7,  "c": 80.4},
    "buckwheat": {"name": "Гречка (сухая)",                 "kcal": 370, "p": 13.3, "f": 3.4,  "c": 71.5},
    "pasta":     {"name": "Макароны (сухие)",               "kcal": 364, "p": 13.0, "f": 1.5,  "c": 74.7},
    "bread_rye": {"name": "Хлеб ржаной",                   "kcal": 257, "p": 8.5,  "f": 3.3,  "c": 48.3},
    "potato":    {"name": "Картофель",                      "kcal": 79,  "p": 2.0,  "f": 0.1,  "c": 17.5},
    ...
    "chicken_thigh": {"name": "Куриное бедро (без кожи)",   "kcal": 202, "p": 26.0, "f": 10.9, "c": 0.0},
    "turkey":    {"name": "Индейка (варёная)",              "kcal": 181, "p": 28.6, "f": 7.4,  "c": 0.0},
    "fish":      {"name": "Рыба белая (минтай/хек)",        "kcal": 87,  "p": 19.4, "f": 1.0,  "c": 0.0},
    "tuna_can":  {"name": "Тунец консервированный",         "kcal": 111, "p": 25.5, "f": 1.0,  "c": 0.0},
    "eggs":      {"name": "Яйца куриные",                   "kcal": 150, "p": 12.6, "f": 10.6, "c": 1.1},
    "curd_2":    {"name": "Творог 2–5%",                    "kcal": 103, "p": 18.0, "f": 2.0,  "c": 3.3},
    "kefir":     {"name": "Кефир 1%",                       "kcal": 39,  "p": 3.4,  "f": 1.0,  "c": 4.0},
    "milk":      {"name": "Молоко 2.5%",                    "kcal": 53,  "p": 2.9,  "f": 2.5,  "c": 4.8},
    # Жиры
    ...
    # Фрукты
    "banana":    {"name": "Банан",                          "kcal": 98,  "p": 1.1,  "f": 0.3,  "c": 22.8},
    "apple":     {"name": "Яблоко",                         "kcal": 58,  "p": 0.3,  "f": 0.2,  "c": 13.8},
}
